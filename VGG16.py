...
def vgg_16(inputs,
  ...
  with variable_scope.variable_scope(scope, 'vgg_16', [inputs]) as sc:
    ...
    with arg_scope(
      ...
      net = layers_lib.max_pool2d(net, [2, 2], scope='pool1'); feature_maps.append(net)
      net = layers_lib.repeat(net, 2, layers.conv2d, 128, [3, 3], scope='conv2');
      net = layers_lib.max_pool2d(net, [2, 2], scope='pool2'); feature_maps.append(net)
      net = layers_lib.repeat(net, 3, layers.conv2d, 256, [3, 3], scope='conv3');
      net = layers_lib.max_pool2d(net, [2, 2], padding='same', scope='pool3'); feature_maps.append(net)
      net = layers_lib.repeat(net, 3, layers.conv2d, 512, [3, 3], scope='conv4'); 
      net = layers_lib.max_pool2d(net, [2, 2], scope='pool4'); feature_maps.append(net)
      net = layers_lib.repeat(net, 3, layers.conv2d, 512, [3, 3], scope='conv5'); 
      net = layers_lib.max_pool2d(net, [2, 2], scope='pool5'); feature_maps.append(net)
      return feature_maps
